...
The substrate concentration throughout the biofilm at a given instant in time is used to compute the growth velocity and detachment velocity. 

From here the first order ordinary differential equation governing biofilm thickness is solved by discretizing with respect to a backwards difference operator.
\end{document}