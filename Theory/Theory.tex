...
In the implementation of flux matching boundary conditions within the biofilm diffusion function as well as in the setup of the substrate concentration within the tank environment function there were issues with LL in the denominator. This lead to errors in further computations as substrate concentration values became NaN.
